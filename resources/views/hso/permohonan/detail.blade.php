                        ...
                        <tbody>
                           @foreach ($data as $item=>$key)
                              <tr class="text-center">
                                 <td>{{ $key->dokumen->nama_dokumen }}</td>
                                 <td>{{ $key->keterangan }}</td>
                                 <td>
                                    {{ Carbon\Carbon::parse($key->created_at)->format('d M Y') }}
                                 </td>
                                 <td>
                                    <a href="{{ url('hso/permohonan-dokumen/'.$key->laporan_tahunan_id.'/laporan/'.$key->id.'/detail') }}" class="text-primary" title="Detail Permohonan">

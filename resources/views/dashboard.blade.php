            ...
            <div class="card news-update">
                ...
                <div class="table-responsive custom-scrollbar">        
                    ...
                    <tbody> 
                        <tr>
                        <td>
                            <div class="media"><img class="img-fluid me-3 b-r-5" src="{{ asset('') }}assets/images/dashboard/rectangle-26.jpg" alt="">
                        ...
                        <tr>
                        <td>
                            <div class="media"> <img class="img-fluid me-3 b-r-5" src="{{ asset('') }}assets/images/dashboard/rectangle-27.jpg" alt="">
                            <div class="media-body"><a href="blog-single.html">
                        ...
                        <tr>
                        <td>
                            <div class="media"><img class="img-fluid me-3 b-r-5" src="{{ asset('') }}assets/images/dashboard/rectangle-28.jpg" alt="">
                            <div class="media-body"><a href="blog-single.html">
                        ...
                        <tr>
                        <td>
                            <div class="media"><img class="img-fluid me-3 b-r-5" src="{{ asset('') }}assets/images/dashboard/rectangle-29.jpg" alt="">
                            <div class="media-body"><a href="blog-single.html">
                        ...
                        <td>
                            ...
                            <div class="media-body image-swipe"><a href="user-profile.html">
                                ...
                                <div class="row gallery">
                                    <figure class="inner-img ms-3" itemprop="associatedMedia" itemscope=""><a href="{{ asset('') }}assets/images/dashboard/img-26.png" itemprop="contentUrl" data-size="600x600"><img class="img-fluid" src="{{ asset('') }}assets/images/dashboard/img-26.png" itemprop="thumbnail" alt="Image description"></a>
                                    <figcaption itemprop="caption description">Photos 1</figcaption>
                                    </figure>
                                    <figure class="inner-img ms-3" itemprop="associatedMedia" itemscope=""><a href="{{ asset('') }}assets/images/dashboard/image-20.jpg" itemprop="contentUrl" data-size="600x600"><img class="img-fluid" src="{{ asset('') }}assets/images/dashboard/image-20.jpg" itemprop="thumbnail" alt="Image description"></a>
